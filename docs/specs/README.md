...
3. **6 项校验**：问题完整性、四段式完整性、法条格式、标签、重复、问题格式
4. **工单留痕**：提交人/时间、AI 结论、审核人/时间、入库来源全链路追溯
5. **归档导出**：法务确认后打包归档（工单+对话+结论）
